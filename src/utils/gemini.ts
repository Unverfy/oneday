...
- Використовуй ТІЛЬКИ реальні, існуючі місця в Україні
- Кожне місце має мати ПОВНУ назву закладу/парку/музею та ПРАВИЛЬНУ адресу
- Перевіряй, що заклади дійсно існують у вказаному місті
- Використовуй тільки реальні назви: наприклад "Парк ім. Горького" (Київ), "Музей історії Вінниці" (Вінниця), "Кав'ярня 'Львівська майстерня шоколаду'" (Львів)
- НЕ вигадуй назви закладів - використовуй тільки ті, що реально існують
- Якщо не впевнений у назві або адресі - краще вказати загальну локацію (наприклад "Центральний парк, Вінниця") або район ("Поділ, Київ")
- Адреси мають бути правильними: вказуй вулицю та номер (наприклад "вул. Соборна, 45, Вінниця")
